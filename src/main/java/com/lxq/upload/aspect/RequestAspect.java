package com.lxq.upload.aspect;

import com.alibaba.fastjson.JSON;
import com.lxq.upload.enums.StateEnums;
...
public class RequestAspect {
     ...
     */
    @Pointcut("execution( * com.lxq.upload.module.*.controller..*(..))")
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        String exception = StringUtils.getPackageException(e, "com.lxq");
